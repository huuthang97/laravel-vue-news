...
<div>
    <footer>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <img src="/frontend/images/logo.svg" class="footer-logo" alt="" />
                    <h5 class="font-weight-normal mt-4 mb-5">
                    Newspaper is your news, entertainment, music fashion website. We
                    provide you with the latest breaking news and videos straight from
                    the entertainment industry. thắng đay
                    </h5>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-3">
                            <img
                                src="/frontend/images/dashboard/home_1.jpg"
                                alt="thumb"
                                class="img-fluid"
                            />
                            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-3">
                            <img
                                src="/frontend/images/dashboard/home_2.jpg"
                                alt="thumb"
                                class="img-fluid"
                            />
                            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-3">
                            <img
                                src="/frontend/images/dashboard/home_3.jpg"
                                alt="thumb"
                                class="img-fluid"
                            />
                            </div>
